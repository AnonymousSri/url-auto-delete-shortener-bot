...
class script(object):
    ...
    START_TXT = environ.get("START_TXT", '''<b>කොහොමද {} 👋🏻 මම PDF පුස්තකාලය Bot😉.</b>

<i>ඔයාට අවශ්‍ය පොත්පත් හොයාගන්න උදව් කරන්න මට පුලුවන් ♥️</i>''')
    HELP_TXT = """𝙷𝙴𝚈 {}
𝙷𝙴𝚁𝙴 𝙸𝚂 𝙼𝚈 𝙷𝙴𝙻𝙿 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂."""
    ABOUT_TXT = """<b><i>Support Group : <a href=https://t.me/pusthakalaya11><b>PDF පුස්තකාලය</b></a>\n
👨‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href=https://t.me/Bots_Lk><b>@Bots_LK</b></a>\n
📝 ʟᴀɴɢᴜᴀɢᴇ : ᴘʏʀᴏɢʀᴀᴍ\n
📚 ꜰʀᴀᴍᴇᴡᴏʀᴋ : ᴘʏᴛʜᴏɴ 3\n
📡 ʜᴏsᴛᴇᴅ ᴏɴ : VPS\n
📢 ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ : <a href=https://t.me/Bots_LK><b></b>@Bots_LK</a>\n
🌟 ᴠᴇʀsɪᴏɴ : ᴠ 4.0\n</b></i>"""
